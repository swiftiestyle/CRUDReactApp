...
export class CourseListContainer3 extends React.Component {
    ...
    handleAddCourse() {
        this.props.history.push('/course3/course3');
    }
    ...
    handleEditCourse() {
        ...
        if (selectedCourseId) {
            ...
            this.props.history.push(`/course3/course3/${selectedCourseId}`);
        }        
    }
...
const mapDispatchToProps = dispatch => ({
    action: bindActionCreators(courseAction3, dispatch)

});



CourseListContainer3.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(CourseListContainer3);
