...
export class AddOrEditCourseContainer2 extends React.Component {
    ...
    handleCancel(event) {
        ...
        this.props.history.replace('/course2');
    }
...
const mapDispatchToProps = dispatch => ({
    action: bindActionCreators({ ...authorAction, ...courseAction2 }, dispatch)
});



AddOrEditCourseContainer2.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(AddOrEditCourseContainer2);
