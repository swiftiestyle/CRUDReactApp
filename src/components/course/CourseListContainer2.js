...
import * as courseAction2 from '../../action/CourseAction2';
import CourseList from './CourseList';



export class CourseListContainer2 extends React.Component {
    ...
    handleAddCourse() {
        this.props.history.push('/course2/course2');
    }
    ...
    handleEditCourse() {
        ...
        if (selectedCourseId) {
            ...
            this.props.history.push(`/course2/course2/${selectedCourseId}`);
        }        
    }
...
const mapDispatchToProps = dispatch => ({
    action: bindActionCreators(courseAction2, dispatch)

});



CourseListContainer2.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(CourseListContainer2);
