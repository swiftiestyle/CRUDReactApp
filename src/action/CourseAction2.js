...
import CourseApi2 from '../api/CourseApi2';
...
export function getCoursesAction() {
    return (dispatch) => {
        ...
        return CourseApi2.getAllCourses()
            .then(courses => {
...
export function saveCourseAction(courseBeingAddedOrEdited) {
    return function (dispatch) {
        ...
        return CourseApi2.saveCourse(courseBeingAddedOrEdited)
            .then(() => {
...
export function getCourseAction(courseId) {
    return (dispatch) => {
        ...
        return CourseApi2.getCourse(courseId)
            .then(course => {
...
export function deleteCourseAction(courseId) {
    return (dispatch) => {
        ...
        return CourseApi2.deleteCourse(courseId)
            .then(() => {
